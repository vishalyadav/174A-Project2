...
void generateSquarePyramid(GLuint program, ShapeData* pyrData);
...
const int numSquarePyramidVertices = 18; //(4 faces)(1 triangles/face)(3 vertices/triangle) +
                                        //(1 face)(2 triangles/face)(3 vertices/triangle)

point4 squarePyramidPoints [numSquarePyramidVertices];
point3 squarePyramidNormals[numSquarePyramidVertices];
point2 squarePyramidUV     [numSquarePyramidVertices];

// Vertices of a square pyramid centered at origin, sides aligned with axes
point4 squarePyramidVertices[5] = {
    point4(    0,    0,  0.5, 1 ),
    point4( -0.5, -0.5, -0.5, 1 ),
    point4(  0.5, -0.5, -0.5, 1 ),
    point4(  0.5,  0.5, -0.5, 1 ),
...
{
    squarePyramidPoints[newIndex] = squarePyramidVertices[a]; squarePyramidNormals[newIndex] = normal;
    squarePyramidUV[newIndex] = point2(0, 0); newIndex++;
    squarePyramidPoints[newIndex] = squarePyramidVertices[b]; squarePyramidNormals[newIndex] = normal;
    squarePyramidUV[newIndex] = point2(1, 0); newIndex++;
    squarePyramidPoints[newIndex] = squarePyramidVertices[c]; squarePyramidNormals[newIndex] = normal;
    squarePyramidUV[newIndex] = point2(0.5, 1); newIndex++;
}

void quadPyr( int a, int b, int c, int d, const point3& normal )
{
    squarePyramidPoints[newIndex] = squarePyramidVertices[a]; squarePyramidNormals[newIndex] = normal;
    squarePyramidUV[newIndex] = point2(0, 1); newIndex++;
    squarePyramidPoints[newIndex] = squarePyramidVertices[b]; squarePyramidNormals[newIndex] = normal;
    squarePyramidUV[newIndex] = point2(0, 0); newIndex++;
    squarePyramidPoints[newIndex] = squarePyramidVertices[c]; squarePyramidNormals[newIndex] = normal;
    squarePyramidUV[newIndex] = point2(1, 0); newIndex++;
    ...
    squarePyramidPoints[newIndex] = squarePyramidVertices[c]; squarePyramidNormals[newIndex] = normal;
    squarePyramidUV[newIndex] = point2(1, 0); newIndex++;
    squarePyramidPoints[newIndex] = squarePyramidVertices[d]; squarePyramidNormals[newIndex] = normal;
    squarePyramidUV[newIndex] = point2(1, 1); newIndex++;
}

void colorSquarePyramid()
{
    tri( 1, 2, 0, point3(  0, -1, 0.5) );
    tri( 4, 1, 0, point3( -1,  0, 0.5) );
    tri( 3, 4, 0, point3(  0,  1, 0.5) );
    tri( 2, 3, 0, point3(  1,  0, 0.5) );
    quadPyr( 4, 1, 2, 3, point3( 0, 0, -1) );
}
...
{
    colorSquarePyramid();
    pyrData->numVertices = numSquarePyramidVertices;
    ...
    // Set vertex attributes
    setVertexAttrib(program,
                    (float*)squarePyramidPoints,  sizeof(squarePyramidPoints),
                    (float*)squarePyramidNormals, sizeof(squarePyramidNormals),
                    (float*)squarePyramidUV,      sizeof(squarePyramidUV));
}
